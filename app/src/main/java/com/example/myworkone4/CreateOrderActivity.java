...
import com.example.myworkone4.adapter.WareOrderAdapter;
import com.example.myworkone4.adapter.layoutmanager.FullyLinearLayoutManager;
import com.example.myworkone4.bean.Charge;
...
public class CreateOrderActivity extends BaseActivity  implements View.OnClickListener {
    ...
    private void postNewOrder(){
        ...
        okHttpHelper.post(Contants.API.ORDER_CREATE, params, new SpotsCallBack<CreateOrderRespMsg>(this) {
            @Override
            public void onSuccess(okhttp3.Response response, CreateOrderRespMsg respMsg) {
...
//                String extraMsg = data.getExtras().getString("extra_msg"); // 错误信息
    ...
    private void changeOrderStatus(final int status){
        ...
        okHttpHelper.post(Contants.API.ORDER_COMPLEPE, params, new SpotsCallBack<BaseRespMsg>(this) {
            @Override
            public void onSuccess(okhttp3.Response response, BaseRespMsg baseRespMsg) {
